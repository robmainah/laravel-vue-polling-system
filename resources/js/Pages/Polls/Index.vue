    ...
    <AuthenticatedLayout>
        ...
        <div class="w-full p-4">
            <div class="flex justify-end mb-4">
                <Link :href="route('polls.create')" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    Create Poll
                </Link>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        <tr v-for="(poll, index) in polls" :key="poll.id">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <Link
                                    :href="route('polls.show', 1)"
                                    class="bg-blue-500 px-2 py-1 rounded-sm text-white hover:text-indigo-900"
                                >View
                                </Link>
                                <Link
                                    :href="route('polls.edit', 1)"
                                    class="bg-red-500 px-2 py-1 rounded-sm text-white hover:text-indigo-900 ms-2"
                                >Delete
                                </Link>
                            </td>
                        </tr>
